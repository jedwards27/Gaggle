        ...
        if (!inBase64) {
          ...
          if (!base64Chars[buf[i2]]) {
            if (i2 == lastI && buf[i2] == minusChar) {
              ...
              var b64str =
                base64Accum + this.iconv.decode(buf.slice(lastI, i2), "ascii");
          ...
          if (!base64IMAPChars[buf[i2]]) {
            if (i2 == lastI && buf[i2] == minusChar) {
              ...
              var b64str =
                base64Accum +
                this.iconv
                  .decode(buf.slice(lastI, i2), "ascii")
                  .replace(/,/g, "/");
              res += this.iconv.decode(
                Buffer2.from(b64str, "base64"),
                "utf16-be",
    ...
    function DBCSCodec(codecOptions, iconv) {
      ...
      if (typeof codecOptions.gb18030 === "function") {
        ...
        for (var i2 = 129; i2 <= 254; i2++) {
          var secondByteNode =
            this.decodeTables[NODE_START - firstByteNode[i2]];
          for (var j = 48; j <= 57; j++) {
        ...
        if (uCode >= 0) {
          ...
          if (i2 >= 3) {
            ...
            var ptr =
              ...
              ((i2 - 2 >= 0 ? buf[i2 - 2] : prevBytes[i2 - 2 + prevOffset]) -
                48) *
                1260 +
              ((i2 - 1 >= 0 ? buf[i2 - 1] : prevBytes[i2 - 1 + prevOffset]) -
                129) *
                10 +
              (curByte - 48);
          }
    ...
    module2.exports = {
      ...
      big5hkscs: {
        ...
        encodeSkipVals: [
          ...
          36457,
          36463, 36478, 36523, 36532, 36557, 36560, 36695, 36713, 36718, 36811,
          36862, 36973, 36986, 37060, 37084, 37105, 37311, 37551, 37552, 37553,
          37554, 37585, 37959, 38090, 38361, 38652, 39285, 39798, 39800, 39803,
          39878, 39902, 39916, 39926, 40002, 40019, 40034, 40040, 40043, 40055,
          40124, 40125, 40144, 40279, 40282, 40388, 40431, 40443, 40617, 40687,
          40701, 40800, 40907, 41079, 41180, 41183, 36812, 37576, 38468, 38637,
...
`);
  ...
  async handlePostMessage(req, res, parsedBody) {
    ...
    let body;
    try {
      const ct = import_content_type.default.parse(
      ...
      body =
        parsedBody !== null && parsedBody !== void 0
          ? parsedBody
          : await (0, import_raw_body.default)(req, {
...
function listAgents() {
  const agents = agentStore_default.getAgents();
  return { agents };
}
